 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.xhaa.example.com", ownerName = "backend.myapplication.xhaa.example.com", packagePath = ""))
